...
public class JFCer extends javax.swing.JFrame {

   CervezaMg mm = new CervezaMg();
    String nomMa;
    int idMa;
    Cerveza ObjMa = new Cerveza();
    public JFCer() {
        initComponents();
        setLocationRelativeTo(null);
    }

    private static String QUERY_NOMBRE="from Cerveza a where a.nombre like '";
    private static String QUERY_ID="from Cerveza a where Idcerveza='";
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(248, 200, 119), new java.awt.Color(248, 200, 119)), "Cerveza", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Rockwell", 1, 12))); // NOI18N
   ...
   private void displayResult(List resultList) {
    ...
    tableHeaders.add("IdCerveza"); 
    tableHeaders.add("Nombre");
    tableHeaders.add("Presentacion");
    tableHeaders.add("Gradacion");
    tableHeaders.add("Tipo");
    tableHeaders.add("Aspecto");
    tableHeaders.add("Procedimiento");
    
    for(Object o : resultList) {
        Cerveza mar = (Cerveza)o;
        Vector<Object> oneRow = new Vector<Object>();
        oneRow.add(mar.getIdcerveza());
        oneRow.add(mar.getNombre());
        oneRow.add(mar.getPresentacion());
        oneRow.add(mar.getGradacion());
        oneRow.add(mar.getTipo());
        oneRow.add(mar.getAspecto());
        oneRow.add(mar.getProcedimientos());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int  e= JOptionPane.showConfirmDialog(this, "¿Seguro que desea eliminar los datos seleccionados?");
            ...
            if (e==0){
               ...
               mm.deleteCerveza(ObjMa.getIdcerveza());
