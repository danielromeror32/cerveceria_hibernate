...
public class JFVenta extends javax.swing.JFrame {
    ...
    private static String QUERY_NOMBRE="from Venta a where a.cantidad like '";
    private static String QUERY_ID="from Venta a where Idventa='";
    ...
    private void runQueryNombre(){
        ...
        vencan = Integer.parseInt(jTextField2.getText());
    executeHQLQuery(QUERY_NOMBRE + jTextField2.getText() + "%'");
    ObjVen = vm.findVentaNom(vencan);
} 
   private void runQueryId(){
       idVe = Integer.valueOf(jTextField1.getText());
    executeHQLQuery(QUERY_ID + jTextField1.getText() + "'");
    ObjVen = vm.findVentaid(idVe);
}   
   
    private void displayResult(List resultList) {
    Vector<String> tableHeaders = new Vector<String>();
    Vector tableData = new Vector();
    tableHeaders.add("IdVenta"); 
    tableHeaders.add("IdExpendio");
    tableHeaders.add("IdCerveza");
    tableHeaders.add("Cantidad");
    tableHeaders.add("Fecha");
    tableHeaders.add("PrecioUnitario");
    
    
    for(Object o : resultList) {
        Venta ven = (Venta)o;
        Vector<Object> oneRow = new Vector<Object>();
        oneRow.add(ven.getIdventa());
        oneRow.add(ven.getExpendio());
        oneRow.add(ven.getCerveza());
        oneRow.add(ven.getCantidad());
        oneRow.add(ven.getFecha());
        oneRow.add(ven.getPrecioUni());
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(248, 200, 119), new java.awt.Color(248, 200, 119)), "Venta", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Rockwell", 1, 12))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        System.out.println(ObjVen.getCantidad());
        JDVenta ModMa = new JDVenta(ObjVen);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (e==0){
            ...
            vm.deleteVenta(ObjVen.getIdventa());
