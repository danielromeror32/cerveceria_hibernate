...
public class JFReceta extends javax.swing.JFrame {
    ...
    private static String QUERY_NOMBRE="from Receta a where a.cantidad like '";
    private static String QUERY_ID="from Receta a where Idreceta='";
    ...
    private void runQueryNombre(){
        //vencan = jTextField2.getText();
        reccan = Integer.parseInt(jTextField2.getText());
    executeHQLQuery(QUERY_NOMBRE + jTextField2.getText() + "%'");
    ObjRec = rm.findRecetaNom(reccan);
} 
   private void runQueryId(){
       idRe = Integer.valueOf(jTextField1.getText());
    executeHQLQuery(QUERY_ID + jTextField1.getText() + "'");
    ObjRec = rm.findRecetaid(idRe);
}   
   
    private void displayResult(List resultList) {
    Vector<String> tableHeaders = new Vector<String>();
    Vector tableData = new Vector();
    tableHeaders.add("IdReceta"); 
    tableHeaders.add("IdIng");
    tableHeaders.add("IdCer");
    tableHeaders.add("Cantidad");

    for(Object o : resultList) {
        Receta rec = (Receta)o;
        Vector<Object> oneRow = new Vector<Object>();
        oneRow.add(rec.getIdreceta());
        oneRow.add(rec.getIngrediente().getIdIngrediente());
        oneRow.add(rec.getCerveza().getIdcerveza());
        oneRow.add(rec.getCantidad());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        System.out.println(ObjRec.getCantidad());
        JDReceta ModMa = new JDReceta(ObjRec);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (e==0){
            ...
            rm.deleteReceta(ObjRec.getIdreceta());
    ...
    public static void main(String args[]) throws java.lang.InstantiationException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFReceta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
