...
public class JFMarca extends javax.swing.JFrame {
   ...
   MarcaMg mm = new MarcaMg();
    String nomMa;
    int idMa;
    Marca ObjMa = new Marca();
    public JFMarca() {
        initComponents();
        setLocationRelativeTo(null);
    }

    private static String QUERY_NOMBRE="from Marca a where a.nombre like '";
    private static String QUERY_ID="from Marca a where Idmarca='";
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(248, 200, 119), new java.awt.Color(248, 200, 119)), "Marca", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Rockwell", 1, 12))); // NOI18N
   ...
   private void displayResult(List resultList) {
    ...
    for(Object o : resultList) {
        ...
        oneRow.add(mar.getIdmarca());
        oneRow.add(mar.getNombre());
        oneRow.add(mar.getFabricante().getIdfabricante());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        JDMarca ModMa = new JDMarca(ObjMa);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int  e= JOptionPane.showConfirmDialog(this, "¿Seguro que desea eliminar los datos seleccionados?");
            ...
            if (e==0){
               ...
               mm.deleteMarca(ObjMa.getIdmarca());
