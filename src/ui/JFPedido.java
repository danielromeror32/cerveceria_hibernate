...
public class JFPedido extends javax.swing.JFrame {
    ...
    private static String QUERY_NOMBRE="from Pedido a where a.cantidad like '";
    private static String QUERY_ID="from Pedido a where Idpedido='";
    ...
    private void runQueryNombre(){
        nomPed = Integer.parseInt(jTextField2.getText());
    executeHQLQuery(QUERY_NOMBRE + jTextField2.getText() + "%'");
    ObjPe = pm.findPedidoNom(nomPed);
} 
   private void runQueryId(){
       idPe = Integer.valueOf(jTextField1.getText());
    executeHQLQuery(QUERY_ID + jTextField1.getText() + "'");
    ObjPe = pm.findPedidoid(idPe);
}   
   
   private void displayResult(List resultList) {
    Vector<String> tableHeaders = new Vector<String>();
    Vector tableData = new Vector();
    tableHeaders.add("IdPedido"); 
    tableHeaders.add("Idexpendio");
    tableHeaders.add("Idfabricante");
    tableHeaders.add("Idcerveza");
    tableHeaders.add("Cantidad");
    tableHeaders.add("fechaPedido");
    tableHeaders.add("fechaEntrega");
    tableHeaders.add("precioUni");
    
    for(Object o : resultList) {
        Pedido ped = (Pedido)o;
        Vector<Object> oneRow = new Vector<Object>();
        oneRow.add(ped.getIdpedido());
        oneRow.add(ped.getExpendio().getIdexpendio());
        oneRow.add(ped.getFabricante().getIdfabricante());
        oneRow.add(ped.getCerveza().getIdcerveza());
        oneRow.add(ped.getCantidad());
        oneRow.add(ped.getFechaPedido());
        oneRow.add(ped.getFechaEntrega());
        oneRow.add(ped.getPrecioUni());
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(248, 200, 119), new java.awt.Color(248, 200, 119)), "Pedido", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Rockwell", 1, 12))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        System.out.println(ObjPe.getCantidad());
        JDPed ModMa = new JDPed(ObjPe);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (e==0){
            ...
            pm.deletePedido(ObjPe.getIdpedido());
