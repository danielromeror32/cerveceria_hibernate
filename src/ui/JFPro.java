...
public class JFPro extends javax.swing.JFrame {

   ProduccionMg mm = new ProduccionMg();
    ...
    private static String QUERY_NOMBRE="from Produccion a where a.nombre like '";
    private static String QUERY_ID="from Produccion a where Idproduccion='";
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(248, 200, 119), new java.awt.Color(248, 200, 119)), "Produccion", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Rockwell", 1, 12))); // NOI18N

        jLabel8.setBackground(java.awt.Color.white);
        jLabel8.setFont(new java.awt.Font("Rockwell", 0, 11)); // NOI18N
        jLabel8.setText("ID produccion:");
   ...
   private void runQueryId(){
       idPr = Integer.valueOf(jTextField1.getText());
    executeHQLQuery(QUERY_ID + jTextField1.getText() + "'");
    ObjPro = mm.findProduccionid(idPr);
}   
   ...
   private void displayResult(List resultList) {
    ...
    for(Object o : resultList) {
        Produccion mar = (Produccion)o;
        Vector<Object> oneRow = new Vector<Object>();
        oneRow.add(mar.getIdproduccion());
        oneRow.add(mar.getCantidad());
        oneRow.add(mar.getFecha());
        oneRow.add(mar.getCerveza().getIdcerveza());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        System.out.println(ObjPro.getIdproduccion());
        JDPro ModMa = new JDPro(ObjPro);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int  e= JOptionPane.showConfirmDialog(this, "¿Seguro que desea eliminar los datos seleccionados?");
            ...
            if (e==0){
               ...
               mm.deleteProduccion(ObjPro.getIdproduccion());
