...
public class JFInv extends javax.swing.JFrame {

   InventarioMg mm = new InventarioMg();
    ...
    private static String QUERY_ID="from Inventario a where Idinventario='";
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(248, 200, 119), new java.awt.Color(248, 200, 119)), "Inventario", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Rockwell", 1, 12))); // NOI18N
   ...
   private void runQueryId(){
       idIn = Integer.valueOf(jTextField1.getText());
    executeHQLQuery(QUERY_ID + jTextField1.getText() + "'");
    ObjInv = mm.findInventarioid(idIn);
}   
   ...
   private void displayResult(List resultList) {
    ...
    tableHeaders.add("Idinventario"); 
    tableHeaders.add("Cantidad");
    tableHeaders.add("Idexpendio");
    tableHeaders.add("Idcerveza");
   
    
    for(Object o : resultList) {
        Inventario mar = (Inventario)o;
        Vector<Object> oneRow = new Vector<Object>();
        oneRow.add(mar.getIdinventario());
        oneRow.add(mar.getCantidad());
        oneRow.add(mar.getExpendio().getIdexpendio());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        System.out.println(ObjInv.getIdinventario());
        JDInv ModMa = new JDInv(ObjInv);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int  e= JOptionPane.showConfirmDialog(this, "¿Seguro que desea eliminar los datos seleccionados?");
            ...
            if (e==0){
               ...
               mm.deleteInventario(ObjInv.getIdinventario());
