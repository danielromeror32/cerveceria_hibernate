...
public class JFIng extends javax.swing.JFrame {

    IngredienteMg im = new IngredienteMg();
    String nomIn;
    int idIn;
    Ingrediente ObjIn =  new Ingrediente ();
    ...
    private static String QUERY_NOMBRE="from Ingrediente a where a.nombre like '";
    private static String QUERY_ID="from Ingrediente a where Idingrediente='";
   ...
   private void displayResult(List resultList) {
    ...
    for(Object o : resultList) {
        ...
        oneRow.add(ing.getIdIngrediente());
        oneRow.add(ing.getNombre());
        oneRow.add(ing.getDescripcion());
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(248, 200, 119), new java.awt.Color(248, 200, 119)), "Ingrediente", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Rockwell", 1, 12))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        System.out.println(ObjIn.getNombre());
        JDIng ModMa = new JDIng(ObjIn);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (e==0){
            ...
            im.deleteIngrediente(ObjIn.getIdIngrediente());
    ...
    public static void main(String args[]) throws java.lang.InstantiationException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFIng.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
