...
public class JDVenta2 extends javax.swing.JDialog {
    ...
    public JDVenta2(java.awt.Frame parent, boolean modal) {
     ...
     public JDVenta2(Venta ven) {
        initComponents();
        setLocationRelativeTo(null);
        op = ven;
        this.jLabel8.setText(String.valueOf(ven.getIdventa()));
        this.jLabel9.setText(String.valueOf(ven.getExpendio().getNombre()));   
        this.jLabel10.setText(String.valueOf(ven.getCerveza().getNombre()));
        this.jLabel11.setText(String.valueOf(ven.getCantidad()));    
        this.jLabel12.setText(ven.getFecha());
        this.jLabel13.setText(String.valueOf(ven.getPrecioUni()));
            
        ultimo = vm.countVenta();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        JDVenta ventana = new JDVenta (op);
        ventana.setVisible (true);
        this.dispose();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
         if (op.getIdventa()<= ultimo) {
            vm.updateVenta(op.getIdventa(), op.getExpendio(),op.getCerveza(), 
                    op.getCantidad(), op.getFecha(),op.getPrecioUni());
            JOptionPane.showMessageDialog(this, "Se ha actualizado Venta correctamente");
        } else {
            vm.guardarVenta(op.getExpendio().getIdexpendio(), 
