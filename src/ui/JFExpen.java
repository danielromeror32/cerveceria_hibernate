...
public class JFExpen extends javax.swing.JFrame {

   ExpendioMg mm = new ExpendioMg();
    String nomMa;
    int idMa;
    Expendio ObjMa = new Expendio();
    public JFExpen() {
        initComponents();
        setLocationRelativeTo(null);
    }

    private static String QUERY_NOMBRE="from Expendio a where a.nombre like '";
    private static String QUERY_ID="from Expendio a where Idexpendio='";
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(248, 200, 119), new java.awt.Color(248, 200, 119)), "Expendio", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Rockwell", 1, 12))); // NOI18N
   ...
   private void displayResult(List resultList) {
    ...
    tableHeaders.add("Responsable");
    tableHeaders.add("Estado");
    tableHeaders.add("Municipio");
    tableHeaders.add("Ubicacion");
    
    for(Object o : resultList) {
        Expendio mar = (Expendio)o;
        Vector<Object> oneRow = new Vector<Object>();
        oneRow.add(mar.getIdexpendio());
        oneRow.add(mar.getNombre());
        oneRow.add(mar.getRfc());
        oneRow.add(mar.getResponsable());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int  e= JOptionPane.showConfirmDialog(this, "¿Seguro que desea eliminar los datos seleccionados?");
            ...
            if (e==0){
               ...
               mm.deleteExpendio(ObjMa.getIdexpendio());
