...
public class JDPro extends javax.swing.JDialog {
    ...
    ProduccionMg pm = new ProduccionMg();
    String idproduccion;
    int ultimo;
    Produccion obs;
    ...
    public JDPro(java.awt.Frame parent, boolean modal) {
       ...
       if (pm.countProduccion() != 0) {
            ultimo = pm.countProduccion() + 1;
            idproduccion = String.valueOf(ultimo);
        } else {
            idproduccion = "1";
        }
    ...
    public JDPro (Produccion pro){
       ...
       this.setLocationRelativeTo(null);
        ...
        this.jComboBox1.setSelectedItem(pro.getCerveza().getIdcerveza());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        int idc = (int) jComboBox1.getSelectedItem();
        Cerveza cer;
        ...
        if (jTextField2.getText().equals("")|| jTextField3.getText().equals("") ){
                   ...
                   Produccion ObjPro = new Produccion( cer, Integer.parseInt(jTextField2.getText()),
                        jTextField3.getText() );
               
                   ObjPro.setIdproduccion(Integer.parseInt(jTextField1.getText()));
                   
                   JDPro2 produccion2 = new JDPro2 (this, true, ObjPro);
